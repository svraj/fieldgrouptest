...
public class JodaDateToStringTimeConverter implements Converter<String, DateTime> {
	
	public static final String PATTERN = "E MM/dd/yyyy HH:mm";
	public static final String TIME_STRING_PATTERN = "HH:mm";
	...
	public DateTime convertToModel(String value,Class<? extends DateTime> targetType, Locale locale)
		...
		DateTimeFormatter fmt = DateTimeFormat.forPattern(TIME_STRING_PATTERN);
	...
	public String convertToPresentation(DateTime value,
		...
		return value.toString(TIME_STRING_PATTERN,locale);
	}
}